...
df_electricity <- data.frame(State= the_states, 
                             Price = as.numeric(gsub(",","",the_price)),
                             Capacity = as.numeric(gsub(",","",the_capacity)),#need gsub to remove the commas
                             Net_Gen = as.numeric(gsub(",","",net_generation)),
