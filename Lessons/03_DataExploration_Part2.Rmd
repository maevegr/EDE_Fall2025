...
>Answer: Need to make sure we understand what the data is made up of. Both for logistical purposes of manipulating data and also so we are using the correct data to learn about the data set.
...
> Answer: bar plot - using categorical data; histogram - looking at frequencies of various numerical data points; frequency polygon - histogram but layering multiple data; box-and-whisker - looking at how the data relates to itself; scatterplot - comparing two variables
