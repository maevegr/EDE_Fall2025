...
> Add notes here: Could indicate the health of the plants and animals in the lakes
...
NTL.phys.data.90_99 <- filter (NTL.phys.data, year4 >=1990 & year4<= 1999)
...
```{r selecting columns}
NTL.phys.data.temps <- select(NTL.phys.data, lakename, sampledate:temperature_C) #lake name and all columns between sample data and temperature
